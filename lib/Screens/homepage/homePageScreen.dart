                      ...
                      children: [
                        ...
                        IconButton(
                          ...
                          onPressed:() async {
                            ...
                            imageFile= await Navigator.push(context, MaterialPageRoute(builder: (context) => UpdateProfile(),));
                            print('================$imageFile}');
             ...
             Padding(
               ...
               child: SingleChildScrollView(
                 ...
                 child: Column(children: [
                           ...
                           child: Padding(
                             ...
                             child: Column(
                               ...
                               children: [
                                 ...
                                 Text('Total Order Today',style: TextStyle(fontSize: 13,fontWeight: FontWeight.bold),),
                                 SizedBox(height: 8,),
                                 Text('${getDashBoardModel?.data?.todayOrders??'0'}',style: TextStyle(fontSize: 10,fontWeight: FontWeight.bold),),
                           ...
                           child: Padding(
                             ...
                             child: Column(
                               ...
                               children: [
                                 ...
                                 Text('Total Product',style: TextStyle(fontSize: 13,fontWeight: FontWeight.bold),),
                                 SizedBox(height: 8,),
                                 Text('${getDashBoardModel?.data?.products??'0'}',style: TextStyle(fontSize: 10,fontWeight: FontWeight.bold),),
                               ],
                   ...
                   Row(
                     children: [
                       ...
                       InkWell(
                           ...
                           child: Text('View All',style: TextStyle(fontSize: 13,fontWeight: FontWeight.bold,color: AppColors.gold),)),
                       SizedBox(width: 10,)
                   ...
                   getOrderModel!.data?.orders!.length==0? Container(


                     width: 150,
                     height: 200,
                     child: Center(child: Text('No Order Found',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 15,color: Colors.black),),),
                   ):
                   ...
                   Container(
                     ...
                     child: ListView.builder(
                       ...
                       itemCount: getOrderModel!.data!.orders!.length,
                         ...
                         return
                           ...
                           InkWell(
                             ...
                             onTap: () {
                               ...
                               Navigator.push(context, MaterialPageRoute(builder: (context) => OrderDetailsSreen(OrderId: getOrderModel?.data?.orders?[index].id.toString()??''),));
                                         ...
                                         Row(
                                           children: [
                                             ...
                                             SizedBox(
                                                 ...
                                                 child: Text('${getOrderModel?.data?.orders?[index].address.addressName},${getOrderModel?.data?.orders?[index].address.area}',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 10),maxLines: 4,)),
                                             SizedBox(width: 10,),
...
Future<void> getdata() async {
 ...
 print('in get token=====imagefile=from get preference=========${imageFile}====================');
...
Future<void> getDashBoard() async {
  print(" token in get dashboard ==================================Bearer ${authToken}===================");
  ...
  var headers = {
    ...
    'Cookie': 'XSRF-TOKEN=%3D; laundry_session=%3D'
  };
  var request = http.Request('GET', Uri.parse('${AppConfig.baseUrl}/dashboard?vendor_id=${venderId}'));
...
Future<void> getOrder() async {
  ...
  print(" token in get order ==================================Bearer ${authToken}============================");
  print(" venderId ==================================Bearer ${venderId}============================");
  final SharedPreferences prefs = await SharedPreferences.getInstance();
  ...
  var headers = {
    'Authorization':'Bearer ${authToken.toString()}',
    'Cookie': 'XSRF-TOKEN=%3D; laundry_session=%3D'
  };
  var request = http.Request('GET', Uri.parse('${AppConfig.baseUrl}/orders?vendors_id=${venderId}'));
