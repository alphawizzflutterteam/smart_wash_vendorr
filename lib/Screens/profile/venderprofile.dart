                    ...
                    CircleAvatar(
                      ...
                      Center(
                        ...
                        CircleAvatar(
                          ...
                          backgroundImage: FileImage(selectedImage!),radius: 45,),
...
// },
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          Text("Please Select Date Of Birth",style: TextStyle(color: Colors.black),overflow:TextOverflow.ellipsis ,maxLines: 1, ):
                          Text("${dateOfBirth}",style: TextStyle(color: Colors.black),overflow:TextOverflow.ellipsis ,maxLines: 1, ),
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          ListTile(
                            ...
                            title:
                            SelectServiceString==null?
                            Text("Please Select Services",style: TextStyle(color: Colors.black),overflow:TextOverflow.ellipsis ,maxLines: 1, ):
                            Text("${SelectServiceString}",style: TextStyle(color: Colors.black),overflow:TextOverflow.ellipsis ,maxLines: 1, ),
  ...
  void loopForService() {
    int loop;
    for(loop=0;loop<getProfileModel!.data!.user!.services!.length;loop++){
      ...
      print(setAllService);
      print('all services for set preference>>>>>>>>>>>==============${setAllService}');
...
var headers = {
  ...
  'Cookie': 'XSRF-TOKEN=%3D; laundry_session=%3D'
};
     var request = http.MultipartRequest('POST', Uri.parse(ApiService.updateProfilephotoUrl));
...
print('in set type of date of birth in side api=======${getProfileModel?.data?.user?.dateOfBirth}');
...
Fluttertoast.showToast(msg: finalll['message']);
  ...
  Future<void> getServices() async {
    ...
    var request = http.Request('GET', Uri.parse('${AppConfig.baseUrl1}/services'));
  ...
  void itmechange(String selectedItem, bool isselectedd) {
    setState(() {
      if (isselectedd) {
        ...
        print("selected dervice item list isSelectedServicelist==============${isSelectedServicelist}");
        print('selected dervice item variable  SelectServiceString==============${SelectServiceString}');
      }
      else {
  ...
  void itmeID(String selectedIteMID, bool isselectedd) {
    setState(() {
      if (isselectedd) {
        ...
        print('service id List  selectedServiceIdlist==========${selectedServiceIdlist}');
        servicesId=selectedServiceIdlist.join(',');
        print('servicesId without list  servicesId=======================${servicesId}');
