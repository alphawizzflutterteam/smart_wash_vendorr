...
getOrderModel?.data?.orders==null||getOrderModel?.data?.orders==''?Container(
...
Padding(
  ...
  child:   RefreshIndicator(
    ...
    RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemCount: getOrderModel?.data?.orders?.length??0,
  ...
  Future<void> getOrder() async {
    ...
    var request = http.Request('GET', Uri.parse('${AppConfig.baseUrl}/orders?vendors_id=${VenderIdd}'));
