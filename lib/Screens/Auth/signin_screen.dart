...
class _LoginScreenState extends State<LoginScreen> {
            ...
            child: Column(
              children: [
                ...
                CustomTextField(
                    ...
                    maxleanthh: 40,controller: emailAndFone,hintt: 'Enter Email Id',validation: 'Please Enter Email Id'),
                SizedBox(
                  height: 10,
                ),
                ...
                CustomTextField(
                    maxleanthh: 15,
                    controller: password,hintt: 'Enter Password',validation: 'Please Enter Password'),
                SizedBox(
                  height: 20,
                ),
                Row(
  ...
  Future<void> loginApi() async {
    ...
    var request = http.MultipartRequest('POST',
        Uri.parse(ApiService.UserLoginApiUrl));
    request.fields.addAll({
      'email':emailAndFone.text ,
         ...
         else
{
  selectServiceType='Both';
         ...
         print("image patth=========${signinModel?.data.user.profilePhotoPath
             }");
         print("selectServiceType in side api=========${selectServiceType}");
         print("dateOfBirth in side api=========${signinModel?.data.user.dateOfBirth}");
