                  ...
                  children: [
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Icon
                            (Icons.camera_alt_outlined,size: 40,color: Colors.grey,),
                        ),
                      ),
                    ):SizedBox()
                  ],
                ...
                ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      if(servicesId==null)
                      {
                        ...
                        if(selectDeliveryTypeId==null||selectDeliveryTypeId=='')
                        {
                          Fluttertoast.showToast(msg: 'Please Select Delivery Type');
                        }
                        else{

                          if(selectedImage==null||selectDeliveryTypeId=='')
                          {
...
setState(() {
    ...
    showDialog(context: context, builder: (context) {
      ...
      StatefulBuilder(builder: (context, setState) {
        return Multiselectrd(items:getServicesModel!.data!.services??[],);
      },);
...
print('serves raj=============${result}');
 ...
 bool ?valueee=false;
  ...
  Future<void> SignupApi() async {
    ...
    var headers = {
      'Cookie': 'XSRF-TOKEN=%3D; laundry_session=%3D'
    };
    var request = http.MultipartRequest('POST', Uri.parse(ApiService.venderRegisterUrl));
